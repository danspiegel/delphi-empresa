...
-- Inserindo usuário MESTRE

INSERT INTO empresa.usuario (id, idusuario, nomeusuario, senha) VALUES
(uuid_generate_v4(), 'MESTRE', 'Usuário MESTRE', 123456);

-- Tabela municipios

CREATE TABLE IF NOT EXISTS empresa.municipios 
(
    codigoibge int NOT NULL,
	nomemunicipio varchar(45) NOT NULL,
	estado varchar(45) NOT NULL,
	CONSTRAINT "PK_municipios_codigoibge" PRIMARY KEY (codigoibge)
);

-- Inserindo Configuração de Envio de Email

CREATE TABLE IF NOT EXISTS empresa.cfg_envemail
(
	id SERIAL NOT NULL,
	...
	CONSTRAINT "PK_cfg_envemail_id" PRIMARY KEY (id)
);

-- Criando sequência para a tabela cfg_envemail

CREATE SEQUENCE cfg_envemail_id INCREMENT 1 MINVALUE 0 MAXVALUE 1;

-- Inserindo municipios

INSERT INTO empresa.municipios (codigoibge, nomemunicipio, estado) VALUES

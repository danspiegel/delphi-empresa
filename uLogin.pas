...
begin
  ...
  Then Begin
          MessageDlg('Os campos de usuário e senha devem ser preenchidos!', mtInformation, [mbOK],0);
          edtUsuario.SetFocus;
       End
  ...
  Else Begin
        ...
        If not QLoginSistema.IsEmpty
          Then Begin
              ...
              uFrmPrincipal.stbStatus.Panels[0].Text := 'Usuário: '+codigo_usuario;
              Close;
            End
        Else Begin
              MessageDlg('Usuário e/ou senha inválido!', mtWarning, [mbOK], 0);
              edtSenha.Text:= '';
              edtSenha.SetFocus;
            End;
        Except
